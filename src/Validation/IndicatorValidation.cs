...
public static class IndicatorValidation
{
    ...
    internal static bool IncludesNumericalFixtures(IIndicator probe)
    {
        var includeNumericalExtremes = CustomerStateValidation.RequiresCheck(probe) || probe is IBuiltInIndicator builtIn && builtIn.BatchName is
            IndicatorName.RSquared or IndicatorName.LinearRegression or IndicatorName.SimpleMovingAverage or IndicatorName.ExponentialMovingAverage or IndicatorName.StandardDeviation or IndicatorName.ArnaudLegouxMovingAverage or IndicatorName.StandardError or IndicatorName.StandardErrorOfTheMean or IndicatorName.Variance or IndicatorName.SimplifiedLeastSquaresMovingAverage or IndicatorName.LeastSquaresMovingAverage or IndicatorName.LeoMovingAverage or IndicatorName.EhlersHammingMovingAverage or IndicatorName.DoubleExponentialMovingAverage or IndicatorName.TripleExponentialMovingAverage or IndicatorName.ZeroLagExponentialMovingAverage
