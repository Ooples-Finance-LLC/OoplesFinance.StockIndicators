...
public sealed class EhlersAdaptiveStochasticIndicatorV1SpecOptions : IIndicatorSpecOptions
{
    public EhlersAdaptiveStochasticIndicatorV1SpecOptions(double cycPart = .5)
    {
