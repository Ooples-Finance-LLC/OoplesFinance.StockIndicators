...
public sealed class VolatilityIndexDynamicAverageIndicatorSpecOptions : IIndicatorSpecOptions
{
    public VolatilityIndexDynamicAverageIndicatorSpecOptions(int length = 20, double alpha1 = .2, double alpha2 = .04,
