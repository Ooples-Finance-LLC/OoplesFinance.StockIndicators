...
internal static partial class StatefulIndicatorFactory
{
    ...
    private static IStreamingIndicatorState? TryCreateFromTypedOptions(IndicatorSpec spec)
    {
        return spec.Options switch
        {
            ...
            ConnorsRelativeStrengthIndexSpecOptions connors => new ConnorsRelativeStrengthIndexState(connors.MaType, connors.Length1, connors.Length2, connors.Length3),
            StochasticConnorsRelativeStrengthIndexSpecOptions connors => new StochasticConnorsRelativeStrengthIndexState(connors.MaType, connors.Length1, connors.Length2, connors.Length3, connors.SmoothLength1, connors.SmoothLength2),
            CCTStochRelativeStrengthIndexSpecOptions => new CCTStochRelativeStrengthIndexState(),
            CCTStochRSISpecOptions cct => new CCTStochRelativeStrengthIndexState(cct.MaType, cct.Length1, cct.Length2, cct.Length3, cct.Length4, cct.Length5, cct.SmoothLength1, cct.SmoothLength2),
            StochasticRelativeStrengthIndexSpecOptions stochastic => new StochasticRelativeStrengthIndexState(stochastic.MaType, stochastic.Length, stochastic.SmoothLength1, stochastic.SmoothLength2),
            StochasticRsiOscillatorSpecOptions stochastic => new StochasticRelativeStrengthIndexState(length: stochastic.RsiLength, stochLength: stochastic.StochLength),
            ...
            FoldedRelativeStrengthIndexSpecOptions folded => new FoldedRelativeStrengthIndexState(folded.MaType, folded.Length),
            RapidRelativeStrengthIndexSpecOptions gainLoss => new RapidRelativeStrengthIndexState(gainLoss.MaType, gainLoss.Length),
            AsymmetricalRelativeStrengthIndexSpecOptions gainLoss => new AsymmetricalRelativeStrengthIndexState(gainLoss.Length),
            AsymmetricalRsiSpecOptions gainLoss => new AsymmetricalRelativeStrengthIndexState(gainLoss.UpLength),
            RelativeMomentumIndexSpecOptions momentum => new RelativeMomentumIndexState(momentum.MaType, momentum.Length, momentum.Momentum),
            IntradayMomentumIndexSpecOptions momentum => new ChandeIntradayMomentumIndexState(momentum.Length),
            ChandeIntradayMomentumIndexSpecOptions momentum => new ChandeIntradayMomentumIndexState(momentum.Length),
            ...
            WilliamsADSpecOptions => new WilliamsAccumulationDistributionState(),
            ...
            SortinoRatioSpecOptions sortino => new SortinoRatioState(sortino.MaType, sortino.Length, sortino.Bmk),
            SharpeRatioSpecOptions sharpe => new SharpeRatioState(sharpe.MaType, sharpe.Length, sharpe.Bmk),
            InformationRatioSpecOptions information => new InformationRatioState(information.MaType, information.Length, information.Bmk),
            ...
            AdaptiveAutonomousRecursiveTrailingStopSpecOptions autonomousStop => new AdaptiveAutonomousRecursiveTrailingStopState(autonomousStop.Length, autonomousStop.Lambda),
            AccumulativeSwingIndexSpecOptions swing => new AccumulativeSwingIndexState(swing.MaType, swing.Length, swing.LimitMove),
            AbsoluteStrengthMTFIndicatorSpecOptions strengthMtf => new AbsoluteStrengthMTFIndicatorState(strengthMtf.MaType, strengthMtf.Length, strengthMtf.SmoothLength),
            ...
            VerticalHorizontalMovingAverageSpecOptions verticalAverage => new VerticalHorizontalMovingAverageState(verticalAverage.Length),
            ...
            EhlersDecyclerSpecOptions basicDecycler => new EhlersDecyclerState(basicDecycler.Length),
            ...
            ElderMarketThermometerSpecOptions thermometer => new ElderMarketThermometerState(thermometer.MaType, thermometer.Length),
            ...
            UpsideDownsideVolumeSpecOptions volumeUpsideDownsideVolume => new UpsideDownsideVolumeState(volumeUpsideDownsideVolume.Length),
            ...
            EhlersSimpleDecyclerSpecOptions simpleDecycler => new EhlersSimpleDecyclerState(simpleDecycler.Length),
            ...
            Ehlers2PoleButterworthFilterV1SpecOptions pole0 => new Ehlers2PoleButterworthFilterV1State(pole0.Length),
            Ehlers2PoleButterworthFilterV2SpecOptions pole1 => new Ehlers2PoleButterworthFilterV2State(pole1.Length),
            Ehlers2PoleSuperSmootherFilterV1SpecOptions pole2 => new Ehlers2PoleSuperSmootherFilterV1State(pole2.Length),
            Ehlers2PoleSuperSmootherFilterV2SpecOptions pole3 => new Ehlers2PoleSuperSmootherFilterV2State(pole3.Length),
            LinearExtrapolationSpecOptions extrapolation => new LinearExtrapolationState(extrapolation.Length),
            RightSidedRickerMovingAverageSpecOptions ricker => new RightSidedRickerMovingAverageState(ricker.Length),
            PolynomialLeastSquaresMovingAverageSpecOptions polynomialCell => new PolynomialLeastSquaresMovingAverageState(polynomialCell.Length),
            ...
            MovingAverageChannelSpecOptions channel => new MovingAverageChannelState(channel.MaType, channel.Length),
            AlligatorJawSpecOptions jaw => new AlligatorIndexState(jawLength: jaw.Length),
            AlligatorTeethSpecOptions teeth => new AlligatorIndexState(teethLength: teeth.Length),
            ...
            HighLowBandsSpecOptions highLowBands => new HighLowBandsState(highLowBands.MaType, highLowBands.Length, highLowBands.PctShift),
            ...
            CompoundRatioMovingAverageSpecOptions compoundRatio => new CompoundRatioMovingAverageState(compoundRatio.MaType, compoundRatio.Length),
            RepulsionMovingAverageSpecOptions repulsion => new RepulsionMovingAverageState(repulsion.MaType, repulsion.Length),
            ElasticVolumeWeightedMovingAverageV1SpecOptions elasticAverage => new ElasticVolumeWeightedMovingAverageV1State(elasticAverage.MaType, elasticAverage.Length),
            ...
            ThreeHmaSpecOptions threeLower => new _3HMAState(threeLower.MaType, threeLower.Length),
            TripleHullMovingAverageSpecOptions tripleHull => new _3HMAState(length: tripleHull.Length),
            _3HMASpecOptions threeFull => new _3HMAState(threeFull.MaType, threeFull.Length),
            HullMovingAverageSpecOptions hullFull => new HullMovingAverageState(hullFull.MaType, hullFull.Length),
            ...
            ElderRayIndexSpecOptions elder => new ElderRayIndexState(elder.MaType, elder.Length),
            ElderRayBullPowerSpecOptions elderBull => new ElderRayIndexState(length: elderBull.Length),
            ...
            AdlSpecOptions adlAlias => new AccumulationDistributionLineState(length: adlAlias.Length),
            ...
            PvtSpecOptions pvt => new PriceVolumeTrendState(pvt.MaType, pvt.Length),
            ...
            DecisionPointPriceMomentumOscillatorSpecOptions decision => new DecisionPointPriceMomentumOscillatorState(length1: 2 * decision.Length + 7,
                length2: decision.Length + 6),
            SmoothedRateOfChangeSpecOptions smoothedReturn => new SmoothedRateOfChangeState(smoothedReturn.MaType, smoothedReturn.RocLength, smoothedReturn.SmoothLength),
            SmoothedRocSpecOptions smoothedRoc => new SmoothedRateOfChangeState(smoothedRoc.MaType, smoothedRoc.Length),
            PmoSpecOptions pmo => new PriceMomentumOscillatorState(maType: pmo.MaType, length1: pmo.Length,
                signalLength: pmo.SignalLength),
            KnowSureThingSpecOptions bank => new KnowSureThingState(bank.MaType, bank.Length1, bank.Length2, bank.Length3, bank.Length4,
                bank.RocLength1, bank.RocLength2, bank.RocLength3, bank.RocLength4, bank.SignalLength),
            PringSpecialKSpecOptions pring => new PringSpecialKState(pring.MaType, pring.Length1, pring.Length2, pring.Length3, pring.Length4,
                pring.Length5, pring.Length6, pring.Length7, pring.Length8, pring.Length9, pring.Length10, pring.Length11, pring.Length12,
                pring.Length13, pring.Length14, pring.SmoothLength),
            SpecialKSpecOptions => new PringSpecialKState(),
            ...
            HoltExponentialMovingAverageSpecOptions holt => new HoltExponentialMovingAverageState(holt.Length, holt.Length),
            ...
            EhlersZeroLagEmaSpecOptions ehlersZero => new EhlersZeroLagExponentialMovingAverageState(length: ehlersZero.Length),
            EhlersZeroLagExponentialMovingAverageSpecOptions ehlersZeroFull => new EhlersZeroLagExponentialMovingAverageState(length: ehlersZeroFull.Length, maType: ehlersZeroFull.MaType),
            ZeroLowLagMovingAverageSpecOptions zeroLow => new ZeroLowLagMovingAverageState(length: zeroLow.Length),
            DoubleExponentialSmoothingSpecOptions => new DoubleExponentialSmoothingState(),
            McNichollMovingAverageSpecOptions mcNicholl => new McNichollMovingAverageState(length: mcNicholl.Length, maType: mcNicholl.MaType),
            ZeroLagTripleExponentialMovingAverageSpecOptions zeroTriple => new ZeroLagTripleExponentialMovingAverageState(length: zeroTriple.Length),
            ...
            EhlersInfiniteImpulseResponseFilterSpecOptions iirFull => new EhlersInfiniteImpulseResponseFilterState(iirFull.Length),
            EhlersFirFilterSpecOptions or EhlersFiniteImpulseResponseFilterSpecOptions => new EhlersFiniteImpulseResponseFilterState(),
            Spencer15PointMovingAverageSpecOptions => new Spencer15PointMovingAverageState(),
            Spencer21PointMovingAverageSpecOptions => new Spencer21PointMovingAverageState(),
            ...
            ChandeQuickStickSpecOptions quickFull => new ChandeQuickStickState(quickFull.MaType, quickFull.Length),
            DeltaMovingAverageSpecOptions deltaAverage => new DeltaMovingAverageState(deltaAverage.MaType, deltaAverage.Length1, deltaAverage.Length2),
            WellesWilderSummationSpecOptions summation => new WellesWilderSummationState(summation.Length),
            WildersSummationMethodSpecOptions summationAlias => new WellesWilderSummationState(summationAlias.Length),
            TrendContinuationFactorSpecOptions continuation => new TrendContinuationFactorState(continuation.Length),
            TrendDetectionSpecOptions => new TrendDetectionIndexState(),
            TrendDetectionIndexSpecOptions detection => new TrendDetectionIndexState(detection.Length1, detection.Length2),
            ...
            VortexIndicatorPlusSpecOptions vip => new VortexIndicatorState(vip.Length),
            VortexIndicatorMinusSpecOptions vim => new VortexIndicatorState(vim.Length),
