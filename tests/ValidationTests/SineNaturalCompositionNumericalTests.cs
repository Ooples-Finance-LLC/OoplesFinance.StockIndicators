...
public sealed class SineNaturalCompositionNumericalTests
{
    public static IEnumerable<object[]> Cases => IndicatorValidationDiscovery.Discover(new[] { typeof(IIndicator).Assembly })
        .Where(c => c.Name.StartsWith("sine-natural-composition/", StringComparison.Ordinal))
    ...
    public void DiscoveryIncludesEveryPromotedComposition()
    {
        ...
        foreach (var type in new[] { typeof(Tma), typeof(TriangularMovingAverage), typeof(SlowSmoothedMovingAverage),
            ...
            Assert.Equal(6, cases.Count(c => c.IndicatorType == type));
    }
    ...
    public void NativeCompositionsAndLegacyMatchIndependentStages(int length)
    {
        ...
        foreach (var natural in new[] { false, true })
        {
            ...
            var kind = natural ? MovingAvgType.NaturalMovingAverage : MovingAvgType.SineWeightedMovingAverage;
            var referenceKind = natural ? 17 : 16;
